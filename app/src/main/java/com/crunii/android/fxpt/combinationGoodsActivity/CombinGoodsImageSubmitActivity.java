...
import com.crunii.android.fxpt.activity.ProductInfoSubmitActivity;
...
public class CombinGoodsImageSubmitActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_combingoodsimagesubmit);
        mContext = this;
        extras = getIntent().getExtras();
        createOrderDemo = (CreateOrderDemo) extras.getSerializable("createOrderDemo");
        productDetailResultDemo = (ProductDetailResultDemo) extras.getSerializable("productDetailResultDemo");
        numberVerifyResult = (NumberVerifyResult) extras.getSerializable("numberVerifyResult");
    ...
    public void doReadCard(View view) {
        String[] titleList = {"成都因纳伟盛","山东信通"};
         new AlertDialog.Builder(CombinGoodsImageSubmitActivity.this).setTitle("请选择身份实名认证设备").setItems(titleList, new DialogInterface.OnClickListener() {
             @Override
             public void onClick(DialogInterface dialogInterface, int i) {
                 Intent intent = new Intent();
                 switch (i){
                     case 0://成都因纳伟盛
                         intent.setClass(CombinGoodsImageSubmitActivity.this,InvsMainActivity.class);
                         break;
                     case 1://山东信通
                         intent.setClass(CombinGoodsImageSubmitActivity.this,MobileReaderActivity.class);
                         break;
                 }
                    ...
                    public void onCheckedChanged(RadioGroup group, int checkedId) {
                        ...
                        switch (checkedId) {
                            case R.id.upload_image://上传图片
                                readIDCardType = "1";
                                intent.setClass(CombinGoodsImageSubmitActivity.this, UploadImageVerifyActivity.class);
                                ...
                                intent.putExtra("modifyOcrCarNum", productDetailResultDemo.modifyOcrCarNum);
                                intent.putExtra("modifyOcrName", productDetailResultDemo.modifyOcrName);
                                intent.putExtra("modifyOcrAddress", productDetailResultDemo.modifyOcrAddress);
...
//                });
        ...
        if (resultCode == RESULT_OK)
            switch (requestCode) {
                case REQUEST_IMAGE1:
                    ...
                    ImageHelper.showImagePreview(CombinGoodsImageSubmitActivity.this, new File(filePath1), image1);
                    break;
                case REQUEST_IMAGE2:
                    ...
                    ImageHelper.showImagePreview(CombinGoodsImageSubmitActivity.this, new File(filePath2), image2);
                    break;
                case REQUEST_IMAGE3:
                    ...
                    ImageHelper.showImagePreview(CombinGoodsImageSubmitActivity.this, new File(filePath3), image3);
                    break;
                case REQUEST_IMAGE4:
                    ...
                    ImageHelper.showImagePreview(CombinGoodsImageSubmitActivity.this, new File(filePath4), image4);
                    break;
                case REQUEST_IDCARD:
                    ocr_cardnum = data.getExtras().getString("cardnum");
                    ocr_name = data.getExtras().getString("name");
    ...
    public void doSubmit(View v) {
        ...
        if (CombinProductInfoSubmitActivity.hasAdd(createOrderDemo) && productDetailResultDemo.verifyOldInfo) {
            if (!numberVerifyResult.verifiedCitizenId.equals(ocr_cardnum)) {
        ...
        Intent i = new Intent(CombinGoodsImageSubmitActivity.this, CombinProductInfoSubmitActivity.class);
        i.putExtras(extras);
